      ...
      <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
        ...
        <form className="space-y-3">
          ...
          <div className="h-14 flex-1 px-4 bg-zinc-950 border-l-zinc-800 rounded-lg flex items-center gap-2">
            ...
            <input className="bg-transparent text-lg placeholder-zinc-400 outline-none flex-1" type="datetime-local" name="occurs_at" placeholder="Data e horário da atividade" />
          </div>
